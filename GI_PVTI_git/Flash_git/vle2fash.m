function [success_flag,vapor_y,liquid_x,vapor_frac, Zgas_vap, Zgas_liq, cubic_time]=vle2fash(mixture,thermo,options)
...
%--------------------------------------------------------------
    ...
    while (1)
        ...
        [liq_fug, vap_fug, Zgas_liq, Zgas_vap, fug_flag] = fugacity(mixture, thermo, liquid_x, vapor_y);
